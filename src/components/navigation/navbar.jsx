...
//<button onClick={handleNavbarMobile} data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" className="inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
//   <span className="sr-only">Open sidebar</span>
      ...
      <ul className="border-t border-gray-700 mt-2 space-y-2 font-medium">
         <li className="pt-8">
            <Link href="/profile" className="flex  items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              ...
              <span className="ml-3 mt-[5px] text-2xl sm:text-base">Profile</span>
            </Link>
         </li>
         <li>
            ...
            <DashboardIcon size={25} />
               ...
               <span className="ml-3 mt-[5px] text-2xl sm:text-base">Dashboard</span>
            </Link>
         </li>
         <li>
            <Link href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            <div className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white">
              ...
              <PricingIcon size={25} />
               ...
               <span className="ml-3 mt-[5px] text-2xl sm:text-base">Plans</span>
            </Link>
         </li>
         <li>
            <Link href="/faq" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            <div className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white">
              
            <FaqIcon size={25} />
              </div>
               
               <span className="ml-3 mt-[5px] text-2xl sm:text-base">FAQ</span>
            </Link>
         </li>
         <li>
            <Link href="/login" onClick={handleSignOut} className="sm:hidden flex absolute bottom-10 items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              { 
