...
<nav className={`sm:hidden fixed top-0 z-40 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700`}>
  <div className="px-3 py-3 lg:px-5 lg:pl-3">
    <div className="flex items-center justify-between">
      ...
      <Link href="/teacher" className="flex  ml-2 md:mr-24">
...
<aside id="default-sidebar" className={`fixed top-0 left-0 z-50 w-64 h-[100%] sm:h-screen transition-transform ${toggle?"-translate-x-full":""} sm:translate-x-0`} aria-label="Sidebar">
   <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
     <Link  href="/teacher" className="flex items-center sm:pl-2.5 sm:mt-0 mt-3.5 mb-3">
      ...
      <ul className="border-t border-gray-700 mt-2 space-y-2 font-medium">
         <li className="pt-8">
            <Link href="/teacher" className="flex  items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">            
         ...
         <li>
            <Link href="/teacher/courses" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            <div className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white">
         ...
         <li>
            <Link href="/teacher/videos" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            <div className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white">
         ...
         <li>
            <Link href="/teacher/login" onClick={handleSignOut} className="sm:hidden flex absolute bottom-10 items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              { 
