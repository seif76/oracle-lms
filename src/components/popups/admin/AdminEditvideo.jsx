...
const AdminEditVideo = ({ show, handleClose, videoData, id, fetchVideos }) => {
  ...
  const [numberOfCodes, setNumberOfCodes] = useState(""); // To store the new uploaded image
  ...
  const handleChange = (e) => {
    const { name, value } = e.target; // Correctly use `name`
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formDataToSend.append("numberOfCodes", numberOfCodes); // Append numberOfCodes
